...
namespace Hgcal10gLinkReceiver {
  ...
  public:
    ...
    bool allConfiguring() {
      ...
      if(_strCfgA=="Pedestal" || _strCfgA=="PedestalNZS" || _strCfgA=="PedestalBC") {
	...
	if(_strCfgA=="PedestalNZS") {
	  _serenityTcds2.uhalWrite("ctrl_stat.ctrl1.en_nzs_reg",1);
	}
	...
	*/
	...
	_serenityTcds2.uhalWrite("ctrl_stat.ctrl.seq_length",1);
	_serenityTcds2.uhalWrite("seq_mem.pointer",0);
	_serenityTcds2.uhalWrite("seq_mem.data",(3481<<16)|0x0004); // CalComing: L1A BC = this+delay+1 = 3481+107+1 = 3589 -> 25
      }
