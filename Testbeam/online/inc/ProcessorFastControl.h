...
namespace Hgcal10gLinkReceiver {
  ...
  public:
    ...
    bool allConfiguring() {
      ...
      if(_strCfgA=="CalibPulse") {
      }

      if(_strCfgA=="CalibPulseBC") {
         _serenityTrgDaq.uhalWrite("daq_ro.DAQro1.latency",3+6*(11));
      
      }


      if(_strCfgA=="PedestalBC") {
  //_serenityTrgDaq.uhalWrite("daq_ro.DAQro0.latency",0+4*(18));
	_serenityTrgDaq.uhalWrite("daq_ro.DAQro1.latency",3+6*(11));
      }
	...
	unsigned threshold((unpacker==0?100:100)-10*(_configuringBCounter%10));
      ...
      if(_strCfgA=="BeamRun" || _strCfgA=="BeamRunNZS") {
        _serenityUnpacker[0].uhalWrite("ctrl_stat.ctrl0.trig_threshold",70);
        _serenityUnpacker[0].uhalWrite("ctrl_stat.config1.tc_self_trig_mask",0xffb);
        _serenityUnpacker[1].uhalWrite("ctrl_stat.ctrl0.trig_threshold",70);
      }

      if(_strCfgA=="BeamRunScintillator" || _strCfgA=="BeamRunScintillatorNZS") {
        _serenityUnpacker[0].uhalWrite("ctrl_stat.ctrl0.trig_threshold",127);
        _serenityUnpacker[1].uhalWrite("ctrl_stat.ctrl0.trig_threshold",127);
       // _serenityTrgDaq.uhalWrite("daq_ro.DAQro1.latency",3+6*(11));   // very very temp
      }

      //if(_strCfgA=="BeamRunScintillatorBC") {
      //  _serenityUnpacker[0].uhalWrite("ctrl_stat.ctrl0.trig_threshold",127);
      //  _serenityUnpacker[1].uhalWrite("ctrl_stat.ctrl0.trig_threshold",127);
      //  _serenityTrgDaq.uhalWrite("daq_ro.DAQro1.latency",3+6*(11));
      //}
