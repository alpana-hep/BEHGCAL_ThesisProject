...
int main(int argc, char *argv[]) {
  ...
  TH1D * nEcondTruncations_500 = new TH1D("nEcondTruncations_500", "", 1, 0, 1);
  TH1D * nBETruncations_500 = new TH1D("nBETruncations_500", "", 1, 0, 1);
  TH1D * nEcondTruncations_200 = new TH1D("nEcondTruncations_200", "", 1, 0, 1);
  TH1D * nBETruncations_200 = new TH1D("nBETruncations_200", "", 1, 0, 1);
  TH1D * nEcondTruncations_100 = new TH1D("nEcondTruncations_100", "", 1, 0, 1);
  TH1D * nBETruncations_100 = new TH1D("nBETruncations_100", "", 1, 0, 1);
  TH1D * nEcondTruncations_3 = new TH1D("nEcondTruncations_3", "", 1, 0, 1);
  TH1D * nBETruncations_3 = new TH1D("nBETruncations_3", "", 1, 0, 1);
  TH1D * nEcondTruncations_5 = new TH1D("nEcondTruncations_5", "", 1, 0, 1);
  TH1D * nBETruncations_5 = new TH1D("nBETruncations_5", "", 1, 0, 1);
  ...
  for (unsigned ievt = 0; ievt < entries; ++ievt) {
    ...
    if (edata->numberOfEcondAsicTruncations() > 500) {
      nEcondTruncations_500->Fill(0.5);
    }
    if (edata->numberOfEcondBeTruncations() > 500) {
      nBETruncations_500->Fill(0.5);
    }
    if (edata->numberOfEcondAsicTruncations() > 200) {
      nEcondTruncations_200->Fill(0.5);
    }
    if (edata->numberOfEcondBeTruncations() > 200) {
      nBETruncations_200->Fill(0.5);
    }
    if (edata->numberOfEcondAsicTruncations() > 25) {
      nEcondTruncations_100->Fill(0.5);
    }
    if (edata->numberOfEcondBeTruncations() > 25) {
      nBETruncations_100->Fill(0.5);
    }

    //filling extra histograms - nEconds truncating >3 or >5
    if (edata->numberOfEcondAsicTruncations() > 3) {
      nEcondTruncations_3->Fill(0.5);
    }
    if (edata->numberOfEcondBeTruncations() > 3) {
      nBETruncations_3->Fill(0.5);
    }
    if (edata->numberOfEcondAsicTruncations() > 5) {
      nEcondTruncations_5->Fill(0.5);
    }
    if (edata->numberOfEcondBeTruncations() > 5) {
      nBETruncations_5->Fill(0.5);
    }
  ...
  nEcondTruncations_500->Write();
  nBETruncations_500->Write();
  nEcondTruncations_200->Write();
  nBETruncations_200->Write();
  nEcondTruncations_100->Write();
  nBETruncations_100->Write();
  nEcondTruncations_3->Write();
  nBETruncations_3->Write();
  nEcondTruncations_5->Write();
  nBETruncations_5->Write();
