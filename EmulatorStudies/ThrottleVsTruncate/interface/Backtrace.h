...
//#define backtraceAssert(b)
#define backtraceAssert(b) if(!(b)){Backtrace();assert(false);}
//#define backtraceAssert(b) if(!(b)){std::cout << #b << std::endl;Backtrace();assert(false);}

#ifdef IN_SRC
// Originally from https://gist.github.com/fmela/591333/c64f4eb86037bb237862a8283df70cdfc25f01d3
