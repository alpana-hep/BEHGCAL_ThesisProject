...
#/afs/cern.ch/user/k/kalpana/work/public/HGCAL_TDAQ/HGCAL_Buffer_Model/CMSSW_11_1_0_pre3/src/emulator_studies
...
#python temp.py
python scripts/readProcess.py 
#./bin/HGCalBufferModel /afs/cern.ch/user/k/kalpana/work/public/HGCAL_TDAQ/HGCAL_Buffer_Model/CMSSW_11_1_0_pre3/src/emulator_studies/data/current_default.json numberOfBx=$1 outputname=$2 filename=$3 hitModifierFile=$4 #\"HGCalBufferModel\"
