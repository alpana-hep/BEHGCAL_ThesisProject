...
TH1D *EcondAsicAnalyser::h1MaxBuffer_BX_;
TH1D *EcondAsicAnalyser::h1MaxBuffer_BX_Luv_;
...
void EcondAsicAnalyser::initialise(bool a) {
  ...
  if(!staticsInitialised_) {
    ...
    h1MaxBuffer_BX_              =new TH1D("EcondAsic_MaxBuffer_BX_",
                                        ";BX at which buffer was maximum occupied (25 ns);Number of ECON-Ds",
                                        5000,0,500000);
    h1MaxBuffer_BX_Luv_             =new TH1D("EcondAsic_MaxBuffer_BX_Luv",
                                          ";LUV;BX at which buffer was maximum occupied (25 ns)",
                                          luvRange,0,luvRange);
...
void EcondAsicAnalyser::finalise() {    
  ...
  h1MaxBuffer_BX_->Fill(econdAsicPtr_->BX_maxBufferSize_);
  h1MaxBuffer_BX_Luv_->Fill(luv+1,econdAsicPtr_->BX_maxBufferSize_);
