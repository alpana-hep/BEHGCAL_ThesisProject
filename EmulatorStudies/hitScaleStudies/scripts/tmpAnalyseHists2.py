...
scans = [
    ('econdbufferlevel_default', 'econdMediumBufferLevel', 'Default'),
    ...
    for fin in proc_files:
        ...
        for h in read_hists_proc + ['fracEcondTruncations', 'fracBETruncations']:
            if h == 'nEcondTruncations':
                print(h, dirname, hist_pool[h].GetBinContent(1))
        ...
        for p in ['fracEcondTruncations',
            ...
            for ib in range(1, plots[p].GetNbinsX() + 1):
                ...
                if p == 'fracEcondTruncations':
                    print(dirname, x_val, p, ib, plots[p].GetBinContent(ib), mean(vals), )
...
GenericOverlayTH1(dat, inputs=[
    ('econdbufferlevel_default', [], 'Default (750 kHz)'),
], hist='FastControlDriver_Fractions', outname='ROC_EcondAsicThrottle_vs_fracEcondTruncations_750',
...
GenericOverlayTH1(dat, inputs=[
    ('econdbufferlevel_default', [], 'Default'),
], hist='FastControlDriver_Fractions', outname='EcondAsicThrottle_vs_econdbufferlevel',
    graphbin=22, style='PL', outdir=outdir, ytitle='EcondAsicThrottle fraction', xtitle='ECON-D Medium level', legend=leg_top_left)
