...
#python temp.py
./bin/HGCalBufferModel /afs/cern.ch/user/k/kalpana/work/public/HGCAL_TDAQ/HGCAL_Buffer_Model/CMSSW_11_1_0_pre3/src/emulator_studies/data/current_default_v10.json numberOfBx=$1 outputname=$2 filename=$3 econdHitAdditiveArg=$4 econdHitScaling=$5 econdHitlayerArg=$6 econdScintHitScalingArg=$7  # triggerRate=$4 econdHitScaling=$5 #\"HGCalBufferModel\"
